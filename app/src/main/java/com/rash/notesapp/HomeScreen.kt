...
import com.rash.notesapp.ui.NoteViewModel
...
fun NoteListItem(note: Note, modifier: Modifier = Modifier, onNavigate: () -> Unit) {
    Card(
        ...
        Text(
            ...
            fontSize = 16.sp,
            color = Color(0xFF555555), // Lighter gray
            textAlign = TextAlign.Start,
            lineHeight = 20.sp,
            modifier = Modifier
                .padding( 8.dp)
...
private fun HomeScreenPreview() {
    NoteListItem(note = Note(5, "Hello this is a test note", "First Note")) {}
}